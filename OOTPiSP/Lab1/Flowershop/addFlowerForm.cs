...
public partial class addFlowerForm : Form
{
    ...
    private void addButton_Click(object sender, EventArgs e)
    {
        ...
        Type flowerType = Type.GetType("Flowershop." + stringType) ?? typeof(object);
    ...
    private void flowersComboBox_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            Type flowerType = Assembly.GetExecutingAssembly().GetType("Flowershop." + stringType) ?? typeof(Flower);
